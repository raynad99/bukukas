...
function getInitialUserData(user: UserProfile | null) {
  ...
  // Sample User Budi Santoso (Isolated Personal Accounts)
  if (user.email === 'budi.santoso@gmail.com' || user.id === 'usr-personal-02') {
    const budiAccounts: BankAccount[] = [
      {
        id: 'acc-budi-cash',
        name: 'Dompet Tunai Budi',
        bankName: 'Physical Cash',
        accountNumber: 'CASH-BUDI-01',
        type: 'cash',
        balance: 850000,
        currency: 'IDR',
        color: '#10b981',
      ...
      {
        id: 'acc-budi-bca',
        name: 'BCA Tabungan Pribadi',
        bankName: 'Bank Central Asia (BCA)',
        accountNumber: '521-089-2810',
        type: 'bank',
        balance: 6450000,
        currency: 'IDR',
        color: '#00529C',
    ...
    const budiTxs: Transaction[] = [
      {
        id: 'tx-budi-1',
        title: 'Gaji Bulanan PT Maju Bersama',
        amount: 8500000,
        type: 'income',
        categoryId: 'cat-salary',
        accountId: 'acc-budi-bca',
        date: new Date().toISOString().slice(0, 7) + '-01',
        time: '08:30',
        notes: 'Gaji pokok bulanan Budi',
        createdAt: Date.now() - 86400000 * 10,
      },
      {
        id: 'tx-budi-2',
        title: 'Belanja Dapur Supermarket',
        amount: 350000,
        type: 'expense',
        ...
        time: '17:15',
        notes: 'Beli bahan makanan & kebutuhan rumah',
        createdAt: Date.now() - 86400000 * 8,
      },
      {
        id: 'tx-budi-3',
        title: 'Makan Siang Warteg & Es Teh',
        amount: 45000,
        type: 'expense',
        categoryId: 'cat-food',
        accountId: 'acc-budi-cash',
    ...
    const budiBills: BillReminder[] = [
      {
        id: 'bill-budi-1',
        title: 'Listrik Rumah Budi (PLN)',
        amount: 320000,
  ...
  const starterAccounts: BankAccount[] = [
    {
      id: `acc-${user.id}-cash`,
      name: 'Dompet Tunai',
      bankName: 'Physical Cash',
      accountNumber: 'CASH-' + user.name.slice(0, 3).toUpperCase(),
      type: 'cash',
      balance: 500000,
      currency: 'IDR',
      color: '#10b981',
  ...
  const starterTxs: Transaction[] = [
    {
      ...
      type: 'income',
      categoryId: 'cat-salary',
      accountId: `acc-${user.id}-main`,
      date: new Date().toISOString().slice(0, 10),
      time: '09:00',
      notes: 'Pencatatan saldo awal pribadi terisolasi',
      createdAt: Date.now(),
    },
  ];
